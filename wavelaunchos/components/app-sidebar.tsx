...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  const primaryNav = dashboardNavItems;
  const secondaryNav = [...dashboardSecondaryNav, ...dashboardResourceNav];
    ...
    >
      <SidebarHeader className="border-b border-border/60 px-6 py-5">
        <Link href="/dashboard" className="flex items-center gap-3">
          <span className="h-8 w-8">
            ...
            >
              <g fill="currentColor">
                ...
                <path d="m5.45373 13.7196c.54545-.2728 1.18182-.4546 1.72726-.6364 2.45451-.6364 5.09081-.5455 7.72711.4545 1.7273.6364 3.4545.9091 5.3636.9091 3.8181 0 7.6362-1.3636 11.1816-3.9999l1.8181-1.45455-.8181-.63636c-.2728-.27273-.6364-.54544-1-.72725l-.5455-.36363-.4545.36363c-.1818.09091-.2727.27272-.4545.36362-4.8181 3.63634-9.6362 4.63634-14.1816 2.90904-3.2727-1.18178-6.54535-1.45451-9.81802-.4545-.27272.0909-.54544.1818-.90907.2727l-.1818.0909-.27274.2727c0 .0909-.09089.0909-.1818.1818-.36363.5455-.81818 1-1.18181 1.5455l-1.72724 2.6363 2.81814-1.4545c.45453 0 .81815-.1818 1.09087-.2727z" />
          ...
          <span className="text-lg font-semibold tracking-tight">WavelaunchOS</span>
        </Link>
      </SidebarHeader>
      <SidebarContent className="flex flex-col gap-6 px-3 py-6">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              className="w-full justify-start gap-3 rounded-lg border border-border/40 bg-transparent px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:border-border hover:bg-border/40 hover:text-foreground"
            >
              ...
              <SidebarMenu key={item.href}>
                <SidebarMenuItem>
                  <SidebarMenuButton
                    asChild
                    className={cn(
                      "justify-start gap-3 rounded-lg px-3 py-2 text-sm font-medium text-muted-foreground transition-colors",
          ...
          {secondaryNav.map((item) => (
            <SidebarMenu key={item.href}>
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  className="justify-start gap-3 rounded-lg px-3 py-2 text-sm text-muted-foreground transition-colors hover:bg-border/40 hover:text-foreground"
                >
                  <Link href={item.href} className="flex items-center gap-3">
                    <item.icon className="h-4 w-4" />
                    <span>{item.title}</span>
      ...
      <SidebarFooter className="border-t border-border/60 px-3 py-5">
        <NavUser
          user={{
            name: session?.user?.name ?? "Admin",
            email: session?.user?.email ?? "admin@wavelaunchos.com",
